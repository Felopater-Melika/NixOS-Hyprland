...
in {
  ...
  systemd.services.coolify-prepare-files = {
    ...
    script = ''
      ...
      cp -f "${./docker/docker-compose.yml}" /data/coolify/source/docker-compose.yml
      cp -f "${./docker/docker-compose.prod.yml}" /data/coolify/source/docker-compose.prod.yml
      cp -f "${./docker/.env}" /data/coolify/source/.env
      cp -f "${./docker/upgrade.sh}" /data/coolify/source/upgrade.sh
